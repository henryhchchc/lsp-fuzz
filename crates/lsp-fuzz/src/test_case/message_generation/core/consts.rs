...
macro_rules! const_generators {
    ...
    (for $type: ty => [
        ...
        impl<State> crate::test_case::message_generation::HasGenerators<State> for $type {
            type Generator = &'static ConstGenerator<Self>;

            fn generators(_config: &crate::test_case::message_generation::GeneratorsConfig) -> impl IntoIterator<Item = Self::Generator> {
