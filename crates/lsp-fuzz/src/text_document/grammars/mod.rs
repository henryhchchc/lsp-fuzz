...
impl GrammarJson {
    ...
    pub const LATEX: &str = include_str!("tree_sitter/latex.json");

    /// The BibTeX grammar generated by tree-sitter
    pub const BIBTEX: &str = include_str!("tree_sitter/bibtex.json");

    /// The Verilog grammar generated by tree-sitter
    pub const VERILOG: &str = include_str!("tree_sitter/verilog.json");

    /// The Solidity grammar generated by tree-sitter
    pub const SOLIDITY: &str = include_str!("tree_sitter/solidity.json");

    /// The Slang grammar generated by tree-sitter
    pub const SLANG: &str = include_str!("tree_sitter/slang.json");
}
...
mod tests {
    ...
    fn load_derivation_grammar_slang() {
        let grammar =
            DerivationGrammar::from_tree_sitter_grammar_json(Language::ShaderLang, GrammarJson::SLANG)
                .unwrap();
        eprintln!("{}", grammar);
        grammar.validate().unwrap();
    }
