...
/// The C++ grammar generated by tree-sitter
pub const CPP_GRAMMAR_JSON: &str = include_str!("tree_sitter/cpp.json");
...
pub const TOML_GRAMMAR_JSON: &str = include_str!("tree_sitter/toml.json");
...
mod tests {
    ...
    fn load_derivation_grammar_cpp() {
        let grammar =
            DerivationGrammar::from_tree_sitter_grammar_json(Language::CPlusPlus, CPP_GRAMMAR_JSON)
                .unwrap();
        eprintln!("{}", grammar);
        grammar.validate().unwrap();
    }
    ...
    fn load_derivation_grammar_toml() {
        let grammar =
            DerivationGrammar::from_tree_sitter_grammar_json(Language::Toml, TOML_GRAMMAR_JSON)
                .unwrap();
        eprintln!("{}", grammar);
        grammar.validate().unwrap();
    }
